...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const Dism = User.user.discriminator, Bot = User.user.bot ? "Si" : "No";
    const Roles = (User.roles.cache.size - 1) == 0 ? "Ninguno" : User.roles.cache.size - 1, Avatar = User.user.avatarURL({ dynamic: true });
