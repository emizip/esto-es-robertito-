...
module.exports = {
    ...
    run: async(bot, message, args) => {
        ...
        if (!args[0]) return message.channel.send("Ingrese el nombre del gremio o el ID del gremio del lugar donde desea el enlace de invitación.")
        ...
        if(args[0]){
            ...
            return message.channel.send("Ese es el nombre de gremio no válido");
        }
        if(guild){
